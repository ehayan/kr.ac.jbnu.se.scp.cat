        ...
        <ListGroup flush>
          ...
          >
            <div>
              ...
              GitHub :
              <a
                className={githubLink === '' ? 'hide' : 'm-l-5'}
              >
                {githubLink}
              </a>
              <button
          ...
          >
            <div>
              ...
              GoogleDrive :
              <a
                className={googleDriveLink === '' ? 'hide' : 'm-l-5'}
              >
                {googleDriveLink}
              </a>
              <button
          ...
          >
            <div>
              ...
              Trello :
              <a
                className={trelloLink === '' ? 'hide' : 'm-l-5'}
              >
                {trelloLink}
              </a>
              <button
          ...
          >
            <div>
              ...
              slack :
              <a
                className={slackLink === '' ? 'hide' : 'm-l-5'}
              >
                {slackLink}
              </a>
              <button

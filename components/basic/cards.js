        ...
        <Row>
          ...
          <Col md='6'>
              <Card body className='card-shadow'>
                ...
                <div className='m-b-5'>
                  <span className='m-r-10 p-t-10 p-b-10 dashboard-member'>최성우</span>
                  <span className='m-r-10 p-t-10 p-b-10 dashboard-member'>김현우</span>
                  <span className='m-r-10 p-t-10 p-b-10 dashboard-member'>이유정</span>
                  <span className='m-r-10 p-t-10 p-b-10 dashboard-member'>이하얀</span>
                </div>
                <hr />
